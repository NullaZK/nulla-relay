...
impl_runtime_weights!(nulla_runtime_constants);
...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: alloc::borrow::Cow::Borrowed("nulla-relay"),
	impl_name: alloc::borrow::Cow::Borrowed("nulla-relay"),
	authoring_version: 2,
...
impl pallet_staking::EraPayout<Balance> for EraPayout {
	fn era_payout(
		...
		// Share to treasury (configurable percentage of yearly emission, default 20%).
		let to_treasury = FixedU128::from_rational(
			TreasuryEraPercent::get() as u128,
			100u128,
		)
		.saturating_mul_int(era_emission);
...
parameter_types! {
	// Treasury share of yearly emission in percent (testnet target: 10–30%).
	pub const TreasuryEraPercent: u8 = 20;
}
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		...
		> {
			...
			parameter_types! {
				...
				pub AssetHubParaId: ParaId = nulla_runtime_constants::system_parachain::ASSET_HUB_ID.into();
