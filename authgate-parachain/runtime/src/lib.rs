...
pub const VERSION: RuntimeVersion = RuntimeVersion {
    spec_name: alloc::borrow::Cow::Borrowed("authgate"),
    impl_name: alloc::borrow::Cow::Borrowed("authgate"),
    authoring_version: 1,
    spec_version: 100,
    impl_version: 0,
...
mod runtime {
    ...
    // AuthGate application pallet
    #[runtime::pallet_index(50)]
    pub type AccessKeys = pallet_access_keys;
}
